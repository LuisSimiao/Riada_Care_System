  ...
  async function handleSubmit(e) {
    ...
    try {
      ...
      const res = await fetch(
        `http://192.168.1.116:3001/api/save-accident-report-pdf?location=${location}&date=${form.text_2ovd}&time=${form.text_3hlzs}`,
        {
          method: "POST",
      ...
      await fetch("http://192.168.1.116:3001/api/acknowledge-alert", {
        method: "POST",
